...
import useLaserListState from 'hooks/useLaserListState';
...
function LaserMenuContents() {
  const navigate = useNavigate();

  const list = useLaserListState();
      ...
      <div className={styles.MenuWrapper}>
        ...
        
        {
          list.map((value,index) => { 
            return (
              <div className={styles.MenuTextWrap} onClick={()=>{LinkClick(value.path)}}>
                <MainMenu>
...
export default LaserMenuContents;
